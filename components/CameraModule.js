        ...
        <View className="flex-1">
            <View className="flex-1 items-center justify-center">
                {openCamera ? (
                    ...
                    <Image source={require("../assets/camera.png")} resizeMode="contain" className="w-52" />
                )}
            </View>
            <View className="w-full bg-[#00B1AC] px-5 py-8">
                <View className="gap-3 w-full">
                    <Pressable className="w-full" onPress={() => setOpenCamera(!openCamera)}>
                    ...
                    <Pressable android_disableSound className="w-full" onPress={() => goBack()}>
                        <View className="bg-white items-center rounded-lg">
                            <Text className="text-[#2D2926] font-bold text-[16px] p-2">Back</Text>
                        </View>
                    </Pressable>
                </View>
            </View>
