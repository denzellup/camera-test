    ...
    return (
        <View className="flex-1">
            <View className="bg-[#00B1AC] p-5 w-full items-center justify-center">
                <Text className="mb-8 text-white font-bold text-4xl pt-12">Success! 🎉</Text>
            </View>
            ...
            <View className="p-5 mb-5">
                <Pressable android_disableSound className="w-full" onPress={() => navigation.navigate("Home")}>
                    <View className="bg-[#FCDC41] items-center rounded-lg">
                        <Text className="text-[#2D2926] font-bold text-[16px] p-2">Back to Home</Text>
                    </View>
                </Pressable>
            </View>
        </View>
